           ...
           @if($match->show==1)
            <div class="col-sm-4" style="border-style: dotted;">
                 <table>
                        ...
                        <tr>
                            <td align="center" >
                                <img src="{{ asset('/build/assets/resources/'.$match->flag_team1) }}" class="size_flag_near_match">
                            </td>
                            <td align="center">
                                <img src="{{ asset('/build/assets/resources/'.$match->flag_team2) }}" class="size_flag_near_match">
                            </td>
                        </tr>
                        <tr>
