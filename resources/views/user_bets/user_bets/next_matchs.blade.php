       ...
       <table class="table" class="tablebets">
        ...
        <tr class="tablebets">
            ...
            <td align="left" class="tablebets">{{$match->name_team1}}
                <img src="{{ mix('/resources/'.$match->flag_team1) }}" class="sizeflag">
                <input type="hidden" name="" class="flag_team1" value="{{ mix('/resources/'.$match->flag_team1) }}">
            ...
            <td align="left" class="tablebets">{{$match->name_team2}}
                <img src="{{ mix('/resources/'.$match->flag_team2) }}" class="sizeflag">
                <input type="hidden" name="" class="flag_team2" value="{{ mix('/resources/'.$match->flag_team2) }}">
