...
<div class="form-group {{ $errors->has('match_date') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="match_date" type="date" id="match_date" value="{{ isset($match->match_date) or ''}}" required="true">
...
<div class="form-group {{ $errors->has('match_hour') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="match_hour" type="time" id="match_hour" value="{{ isset($match->match_hour) or ''}}" required="true">
